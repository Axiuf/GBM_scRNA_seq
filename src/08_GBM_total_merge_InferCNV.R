...
library(Seurat)
library(infercnv)
dir.create("./data/08_GBM_total_merge_InferCNV")
...
write.table(cell_Annotations, file = "./data/08_GBM_total_merge_InferCNV/cell_Annotations.txt", quote = F, sep= "\t", col.names = FALSE)


# InferCNV
infercnv_obj = CreateInfercnvObject(raw_counts_matrix = counts_matrix,
                                    annotations_file = "./data/08_GBM_total_merge_InferCNV/cell_Annotations.txt",
...
infercnv_obj = infercnv::run(infercnv_obj,
                             cutoff = 0.1,
                             out_dir = "./data/08_GBM_total_merge_InferCNV", 
                             window_length = 101,
