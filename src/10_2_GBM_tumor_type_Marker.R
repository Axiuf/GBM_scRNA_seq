...
dir.create("./plots/10_2_GBM_tumor_type_Marker")
fig_dpi <- 150
...
plot1 + plot2 + plot3
ggsave(filename = "cluster_tumor_patient_dimplot.tiff", device = "tiff", path = "./plots/10_2_GBM_tumor_type_Marker", width = 24, height = 7, dpi = fig_dpi)
...
FeaturePlot(GBM, reduction = "umap", 
            ...
            min.cutoff = 'q15',
            label = TRUE)
ggsave(filename = "metrics_FeaturePlot.tiff", device = "tiff", path = "./plots/10_2_GBM_tumor_type_Marker", width = 16, height = 21, dpi = fig_dpi)
...
metadata %>% 
  ...
  theme_classic()
ggsave(filename = "percent.mt_geom_freqpoly.tiff", device = "tiff", path = "./plots/10_2_GBM_tumor_type_Marker", width = 10, height = 5, dpi = fig_dpi)
...
group %>% 
  ...
  theme_classic()
ggsave(filename = "tumor_by_cluster0.2_geom_bar.tiff", device = "tiff", path = "./plots/10_2_GBM_tumor_type_Marker", width = 14, dpi = fig_dpi)
...
ggsave(filename = "Cell_cycle_markers_FeaturePlot.tiff", device = "tiff", path = "./plots/10_2_GBM_tumor_type_Marker",width = 16, height = 21, dpi = fig_dpi)
...
ggsave(filename = "Cell_type_markers_FeaturePlot.tiff", device = "tiff", path = "./plots/10_2_GBM_tumor_type_Marker",width = 30, height = 30, dpi = fig_dpi)