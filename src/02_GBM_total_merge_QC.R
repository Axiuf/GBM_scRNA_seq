...
dir.create("./plots/02_GBM_total_merge_QC")
dir.create("./plots/02_GBM_total_merge_QC/percent.mt_VlnPlot")
fig_dpi <- 150
...
for(GBM_sample_name in levels(GBM@active.ident)){
  ...
  ggsave(filename = file_name, device = "tiff", path = "./plots/02_GBM_total_merge_QC/percent.mt_VlnPlot", dpi = fig_dpi)
}
...
plot1 + plot2
ggsave(filename = "percent.mt&nFeature_RNA_by_nCount_FeatureScatter.tiff", device = "tiff", path = "./plots/02_GBM_total_merge_QC", width = 14, dpi = fig_dpi)
...
metadata %>% 
  ...
  ggtitle("nCells")
ggsave(filename = "nCells_by_sample_geom_bar.tiff", device = "tiff", path = "./plots/02_GBM_total_merge_QC", width = 8, dpi = fig_dpi)
...
ggsave(filename = "nCount_RNA_by_sample_geom_density.tiff", device = "tiff", path = "./plots/02_GBM_total_merge_QC", width = 14, height = 5, dpi = fig_dpi)
...
ggsave(filename = "nFeature_RNA_by_sample_geom_density.tiff", device = "tiff", path = "./plots/02_GBM_total_merge_QC", width = 14, height = 5, dpi = fig_dpi)
...
ggsave(filename = "nCells_vs_nFeature_RNA_geom_boxplot.tiff", device = "tiff", path = "./plots/02_GBM_total_merge_QC", width = 14, height = 5, dpi = fig_dpi)
...
ggsave(filename = "percent.mt_geom_point.tiff", device = "tiff", path = "./plots/02_GBM_total_merge_QC", width = 25, height = 40, dpi = fig_dpi)
...
ggsave(filename = "percent.mt_geom_density.tiff", device = "tiff", path = "./plots/02_GBM_total_merge_QC", width = 14, height = 5, dpi = fig_dpi)
...
ggsave(filename = "log10GenesPerUMI_geom_density.tiff", device = "tiff", path = "./plots/02_GBM_total_merge_QC", width = 14, height = 5, dpi = fig_dpi)
...
plot1 + plot2
ggsave(filename = "filtered_percent.mt&nFeature_RNA_by_nCount_FeatureScatter.tiff", device = "tiff", path = "./plots/02_GBM_total_merge_QC", width = 14, dpi = fig_dpi)


saveRDS(GBM_filtered, file = "./data/02_GBM_total_merge_filtered.rds")