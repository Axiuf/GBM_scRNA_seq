...
library(Seurat)
dir.create("./data/1_Creat_seurat_objects")
dir.create("./data/1_Creat_seurat_objects/excluded")
dir.create("./data/1_Creat_seurat_objects/merged_objects")
...
GBM_objects <- lapply(GBM_sample_names, function(GBM_sample_name){
  ...
  saveRDS(raw_object, file = paste0("./data/1_Creat_seurat_objects/", GBM_sample_name, ".rds"))
  
  raw_object
})


# Move P768.rds (in which cell count is too small) to "./data/1_Creat_seurat_objects/excluded".
file.copy("./data/1_Creat_seurat_objects/P768.rds", "./data/1_Creat_seurat_objects/excluded/P768.rds")
file.remove("./data/1_Creat_seurat_objects/P768.rds")
...
saveRDS(GBM_total_merge, file = "./data/1_Creat_seurat_objects/merged_objects/GBM_total_merge.rds")
...
saveRDS(primary_total_merge, file = "./data/1_Creat_seurat_objects/merged_objects/primary_total_merge.rds")
...
saveRDS(recurrent_total_merge, file = "./data/1_Creat_seurat_objects/merged_objects/recurrent_total_merge.rds")
...
saveRDS(Secondary_total_merge, file = "./data/1_Creat_seurat_objects/merged_objects/Secondary_total_merge.rds")
