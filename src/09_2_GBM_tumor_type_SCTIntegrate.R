# Directly SCTIntegrate all data by patient. Ignore tumor type informations in this step.
...
# Creat output dir.
dir.create("./plots/09_2_GBM_tumor_type_SCTIntegrate")
plots_dir <- paste0("./plots/09_2_GBM_tumor_type_SCTIntegrate/", "integrate_dim_", integrate_dim[1])
