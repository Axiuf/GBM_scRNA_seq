...
GBM_objects <- lapply(GBM_sample_names, function(GBM_sample_name){
  ...
  saveRDS(raw_object, file = paste0("./data/raw_objects/", GBM_sample_name, ".rds"))
  
  raw_object
})


# Move P768.rds (in which cell count is too small) to "./data/raw_objects/excluded".
file.copy("./data/raw_objects/P768.rds", "./data/raw_objects/excluded/P768.rds")
file.remove("./data/raw_objects/P768.rds")
...
saveRDS(GBM_total_merge, file = "./data/raw_objects/merged_objects/GBM_total_merge.rds")
...
saveRDS(primary_total_merge, file = "./data/raw_objects/merged_objects/primary_total_merge.rds")
...
saveRDS(recurrent_total_merge, file = "./data/raw_objects/merged_objects/recurrent_total_merge.rds")
...
saveRDS(Secondary_total_merge, file = "./data/raw_objects/merged_objects/Secondary_total_merge.rds")
