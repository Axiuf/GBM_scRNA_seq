...
for(GBM_sample_name in levels(GBM@active.ident)){
  ...
  ggsave(filename = file_name, device = "tiff", path = "./plots/GBM_total_merge_QC/percent.mt_VlnPlot", dpi = 150)
}
...
plot1 + plot2
ggsave(filename = "percent.mt&nFeature_RNA_by_nCount_FeatureScatter.tiff", device = "tiff", path = "./plots/GBM_total_merge_QC", width = 14, dpi = 150)


# https://github.com/hbctraining/scRNA-seq/blob/master/lessons/04_SC_quality_control.md
# Plot differents metrics to assess the data validity.
...
metadata %>% 
  ...
  ggtitle("nCells")
ggsave(filename = "nCells_by_sample_geom_bar.tiff", device = "tiff", path = "./plots/GBM_total_merge_QC", width = 8, dpi = 150)
...
ggsave(filename = "nCount_RNA_by_sample_geom_density.tiff", device = "tiff", path = "./plots/GBM_total_merge_QC", width = 14, height = 5, dpi = 150)
...
ggsave(filename = "nFeature_RNA_by_sample_geom_density.tiff", device = "tiff", path = "./plots/GBM_total_merge_QC", width = 14, height = 5, dpi = 150)
...
ggsave(filename = "nCells_vs_nFeature_RNA_geom_boxplot.tiff", device = "tiff", path = "./plots/GBM_total_merge_QC", width = 14, height = 5, dpi = 150)
...
ggsave(filename = "percent.mt_geom_point.tiff", device = "tiff", path = "./plots/GBM_total_merge_QC", width = 25, height = 40, dpi = 150)
...
ggsave(filename = "percent.mt_geom_density.tiff", device = "tiff", path = "./plots/GBM_total_merge_QC", width = 14, height = 5, dpi = 150)
...
ggsave(filename = "log10GenesPerUMI_geom_density.tiff", device = "tiff", path = "./plots/GBM_total_merge_QC", width = 14, height = 5, dpi = 150)
...
plot1 + plot2
ggsave(filename = "filtered_percent.mt&nFeature_RNA_by_nCount_FeatureScatter.tiff", device = "tiff", path = "./plots/GBM_total_merge_QC", width = 14, dpi = 150)


saveRDS(GBM_filtered, file = "./data/GBM_total_merge_filtered.rds")